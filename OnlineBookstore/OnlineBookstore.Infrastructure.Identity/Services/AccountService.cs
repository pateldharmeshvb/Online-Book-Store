...
using OnlineBookstore.Infrastructure.Identity.Helpers;
...
namespace OnlineBookstore.Infrastructure.Identity.Services
{
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailService.SendAsync(new Application.DTOs.Email.EmailRequest() { From = "pateldharmeshvb@gmail.com", To = user.Email, Body = $"Please confirm your account by visiting this URL {verificationUri}", Subject = "Confirm Registration" });
